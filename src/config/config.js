...
const envVarSchema = Joi.object().keys({
  ...
  PORT: Joi.number().default(3000), // 數字且預設值為 8080
  MYSQL_PORT: Joi.number().default(3306), // 數字且預設值為3306
  MYSQL_HOST: Joi.string().default('127.0.0.1'), // 字串取預設值為127.0.0.1
  MYSQL_USER: Joi.string().default('admin'), // 字串
  MYSQL_PASS: Joi.string().default('gbsoft2020'), // 字串
  MYSQL_DATABASE: Joi.string().default('lunch'), // 字串
